...
function yearly(dateString){
	...
	document.write("<table id='yearly_table'><tr><th id='yearly_title' colspan='4'>"+thisYear+"</th></tr>")
...
function writeMonthTitle(calendarDay) {
   ...
   //4
   thisMonth = monthName[thisMonth];

   document.write("<tr>");
   document.write("<th class='monthly_title' colspan='7'>");
   //4
   document.write("<a href='"+ thisMonth +".htm'>"+ thisMonth +"</a>");
   document.write("</th>");
   document.write("</tr>");
}
