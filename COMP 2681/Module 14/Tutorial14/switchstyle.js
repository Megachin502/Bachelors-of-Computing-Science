...
function changeStyle(sheet){
	...
	for(var i = 0;i<links.length;i++){
		//Picks out only the links from preferred or alternate style sheets
		if((links[i].rel = "stylesheet" || links[i].rel == "altermate stylesheet")&& links[i].hasAttribute("title")){
